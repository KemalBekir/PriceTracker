...
const Details = () => {
  ...
  useEffect(() => {
    if (itemId) {
      CatalogService.getById(itemId).then((result) => {
        setData(result);
      });
    } else {
        ...
        <div className="mx-auto flex flex-wrap lg:w-4/5">
          ...
          <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:py-6 lg:pl-10">
            ...
            <div className="flex">
              ...
              <a href={data?.url} className="ml-auto flex rounded border-0 bg-red-500 px-6 py-2 text-white hover:bg-red-600 focus:outline-none">
                Link
              </a>
